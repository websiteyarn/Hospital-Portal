                        ...
                        <div class="flex flex-row w-full h-full">
                            ...
                            <div class="w-[60%] h-full">
                                ...
                                <div class="flex flex-row justify-center items-center w-fit h-fit ml-10 mt-9">
                                    ...
                                    <input
                                        class="w-[500px] h-[42px] ml-[120px] pl-10 pr-3 leading-5 text-black placeholder-gray-500 bg-form-fill border border-gray-200 rounded-full focus:outline-none sm:text-sm"
                                        type="text"
                                ...
                                <div class="flex flex-row justify-center items-center w-fit h-fit ml-10 mt-9">
                                    ...
                                    <input
                                        class="w-[500px] h-[42px] ml-[88px] pl-10 pr-3 leading-5 text-black placeholder-gray-500 bg-form-fill border border-gray-200 rounded-full focus:outline-none sm:text-sm"
                                        type="text"
