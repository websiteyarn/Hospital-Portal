...
if(isset($_POST['diagnosis-edit']) && isset($_POST['date-edit']) && isset($_POST['treatment-edit'])){
    $noteID = $_GET['update_diagnosis'];
    $diagnosis = $_POST['diagnosis-edit'];
    $date = $_POST['date-edit'];
    $treatment = $_POST['treatment-edit'];

    $query = "UPDATE `illness` SET `Illness`='$diagnosis',`date`='$date',`status`='$treatment' WHERE illnessID=$noteID;";
                        ...
                        <div class="flex flex-row mx-12 mb-16">
                            ...
                            <div class="flex-col w-1/2">
                                ...
                                <div class="flex flex-row flex-wrap gap-2 mb-3">
                                    <?php 
                                        if($_GET['update_diagnosis'] != "none"){
                                            $diagnosisID = $_GET['update_diagnosis'];
                                            // echo  "UserID:".$patientID;
                                            // $doctorID = $_SESSION['doctorID']; // change to $_SESSION['doctorID'];
                                            //echo  "DoctorID:".$doctorID;
                                            $query = "SELECT * FROM `illness` WHERE illnessID=$diagnosisID;";
                                            $result = mysqli_query($con, $query);
                                    ...
                                    <!-- <div class="flex flex-row items-center">
                                        ...
                                        <div>
                                            <p class="text-2xl"></p>
                                            <p class="text-gray-text text-base"></p>
                                        </div>
                                    </div> -->
