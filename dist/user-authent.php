                ...
                <h class="font-Commissioner text-5xl pb-5 w-[60%] text-gray-500 text-center leading-tight">Welcome to your gateway to wellness!</h>
                    ...
                    <div class="w-[50%]">
                        <a href="user-login.php">
                            <button class=" shadow appearance-none border rounded-[200px] bg-gray-400 border-slate-700 w-full py-5 px-7 text-gray-700 text-center text-2xl mb-3 leading-tight focus:outline-none focus:shadow-outline">
                                Login
                            </button>
                        </a>
                    </div>
