...
<html>
    ...
    <div class = "flex flex-col lg:flex-row h-screen">
            ...
            <div class=" flex flex-col w-[100%] xl:w-[60%] p-5 justify-center items-center gap-2">
                ...
                <p class="font-Commissioner pt-5 mb-60 sm:mb-36 w-[100%] sm:w-[80%] md:w-[70%] text-center text-gray-500 ">By using this service, you understood and agree to the ISY Online Services Terms of Use and Privacy Statement</p>
            </div>
        </div>
    </body>
</html>
