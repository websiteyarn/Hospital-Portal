    ...
    <div class = "flex flex-col lg:flex-row h-screen">
            ...
            <div class=" flex flex-col w-[100%] xl:w-[60%] p-5 justify-center items-center gap-2">
                ...
                <form class="w-full sm:w-[65%] md:w-[70%] lg:w-[60%] font-Commissioner" method="post">
                    <div class="mb-4">
                        <input class="shadow appearance-none border rounded-[200px] border-slate-500 w-full  py-3 xl:py-5 px-7 text-gray-700 text-center text-2xl leading-tight focus:outline-none focus:shadow-outline" name="email" type="text" placeholder="Email">
                    </div>
                    <div class="mb-4">
